...
function gwp_css_selector_render_editor_js(){
      $modal_html = "
			  ...
			  <ul class='gwp_css_ul'>
                <li>
                  <a class='gwp_css_acc_link' href='#'>" . __( 'Documentation', 'gravitywp-css-selector' ) . "</a>
				  <div class='gwp_css_accordian'>
                    ...
                    <a class='gwp_css_link_doc' href='https://gravitywp.com/plugins/css-selector/' target='_blank'>" . __( 'Other Documentation', 'gravitywp-css-selector' ) . "</a>
                  </div>
                </li>
			  </ul>
			  ";
