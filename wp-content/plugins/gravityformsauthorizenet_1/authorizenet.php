...
/*
Plugin Name: Gravity Forms Authorize.Net Rusty Add-On
...
add_action( 'gform_loaded', array( 'GF_AuthorizeNet_Bootstrapcustom', 'load' ), 5 );

class GF_AuthorizeNet_Bootstrapcustom {
	...
	public static function load() {
		...
		GFAddOn::register( 'GFAuthorizeNetcustom' );
	}

}

function gf_authorizenet_1() {
	return GFAuthorizeNetcustom::get_instance();
}