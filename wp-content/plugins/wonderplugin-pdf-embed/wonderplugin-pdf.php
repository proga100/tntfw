<?php
/*
Plugin Name: WonderPlugin PDF Embed
...
class WonderPlugin_PDF_Plugin {
	...
	function register_menu() {
		...
		$menu = add_menu_page(
				__('WonderPlugin PDF Embed', 'wonderplugin_pdf'),
				__('WonderPlugin PDF Embed', 'wonderplugin_pdf'),
				'manage_options',
	...
	function shortcode_handler($atts, $content = null) {
		...
		if ( empty($atts['src']) )
		{
			return __('No URL defined for WonderPlugin PDF Embed', 'wonderplugin_pdf');
		}
		...
		$iframe = '<iframe scrolling="no" class="wonderplugin-pdf-iframe" src="' . $src . '"';
	...
	function edit_settings() {
		...
		?>
		<div class='wrap'>			
		<h2><?php _e( 'WonderPlugin PDF Embed Settings', 'wonderplugin_pdf' ); ?> </h2>
